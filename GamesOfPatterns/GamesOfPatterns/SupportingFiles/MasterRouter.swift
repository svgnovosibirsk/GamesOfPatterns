    ...
    func showViewController(name: String) {
        ...
        case PatternsNames.ChainOfResponsibility.rawValue:
            masterPresenter.view.splitViewController?.showDetailViewController(ChainOfResponsibilityViewController(),
                                                                               sender: self)
        case PatternsNames.Command.rawValue:
            masterPresenter.view.splitViewController?.showDetailViewController(ComandViewController(),
                                                                               sender: self)
        ...
        case PatternsNames.Mediator.rawValue:
            masterPresenter.view.splitViewController?.showDetailViewController(MediatorViewController(),
                                                                               sender: self)
        case PatternsNames.Momento.rawValue:
            masterPresenter.view.splitViewController?.showDetailViewController(MomentoViewController(),
                                                                               sender: self)
